...
FROM 
    afu_geologie.geologie_pleistozaen AS pleistozaen
    ...
    LEFT JOIN afu_geologie.geologie_geologische_schicht_sackung_festgestein AS sackung_festgestein_code
    ...
    LEFT JOIN afu_geologie.geologie_geologische_schicht_verkittungsgrad_lockergestein AS verkittungsgrad_lockergestein_code
    ...
    LEFT JOIN afu_geologie.geologie_geologische_schicht_grundwasser_art AS grundwasser_art_code
